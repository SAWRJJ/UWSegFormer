...
class ELL(nn.Module):
    def __init__(self, isdetach=True, max_N_ratio = 1/100, ignore_label = 255, label_smoothing=0.2, weight = None, max_clip_dist = 20.,use_sigmoid=False, loss_weight=1.0):
    ...
    def forward(self, logits, target,weight=None,ignore_index=255):
        eps = 1e-10
