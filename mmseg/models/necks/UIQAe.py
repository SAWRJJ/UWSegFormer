...
class UIQAe(nn.Module):
    def __init__(self, vis=False, img_size=[256, 256], channel_num=[64, 128, 256, 512], patchSize=[32, 16, 8, 4],
        ...
        # print(1/0)
        self.sobel_x1, self.sobel_y1 = get_sobel(32, 32)
        self.sobel_x2, self.sobel_y2 = get_sobel(64, 64)
        self.sobel_x3, self.sobel_y3 = get_sobel(160, 160)
        self.sobel_x4, self.sobel_y4 = get_sobel(256, 256)
    ...
    def forward(self, x):
        s1, s2, s3, s4 = x[0],x[1],x[2],x[3]
        en1 = run_sobel(self.sobel_x1,self.sobel_y1,x[0])
        en2 = run_sobel(self.sobel_x2, self.sobel_y2, x[1])
        en3 = run_sobel(self.sobel_x3, self.sobel_y3, x[2])
        en4 = run_sobel(self.sobel_x4, self.sobel_y4, x[3])
