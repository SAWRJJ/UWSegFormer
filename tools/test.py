...
# tensorboard --logdir=D:\\PythonV6\\SegFormer-master\\work_dirs\\segformer_e+PPsegHead1.b0.640x480.suim.160k(81.68)\\tf_logs
def parse_args():
...
def main():
    ...
    if rank == 0:
        ...
        if args.eval:
            # print(outputs)
            # print(dataset.evaluate(outputs, args.eval, **kwargs)['mIoU'])
